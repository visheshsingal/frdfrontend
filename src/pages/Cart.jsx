...
const Cart = () => {
  ...
  return (
    <div className="border-t pt-14 text-[#052659] bg-white">
          ...
          return (
            <div key={index} className="py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4">
              <div className="flex items-start gap-6">
                <img className="w-16 sm:w-20 rounded shadow" src={productData.image[0]} alt="" />
                <div>
              ...
              <input
                ...
                className="border max-w-10 sm:max-w-20 px-1 sm:px-2 py-1 rounded text-center outline-none"
                type="number"
                min={1}
        ...
        <div className="w-full sm:w-[450px]">
          ...
          <div className="w-full text-end">
            <button
              ...
              className="bg-[#052659] text-white text-sm my-8 px-8 py-3 rounded hover:opacity-90 transition"
            >
              PROCEED TO CHECKOUT
            </button>
          </div>
