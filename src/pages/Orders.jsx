    ...
    <div className="border-t border-green-800 pt-16 bg-black min-h-screen text-white">
      ...
      <div className="max-w-6xl mx-auto px-4">
        {orders.length === 0 ? (
          ...
          orders.map((order) => (
            <div key={order._id} className="bg-gray-900 rounded-xl p-6 mb-6 border border-green-800 shadow-lg">
              ...
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 pb-4 border-b border-gray-700">
                <div>
                  ...
                  <div className="text-gray-300 space-y-1 text-sm">
                    ...
                    <p>💳 Payment: <span className={order.payment ? 'text-green-400' : 'text-red-400'}>
              ...
              {order.items && order.items.length > 0 ? (
                <div className="mb-6">
                  <h4 className="text-green-400 font-semibold text-lg mb-4">Order Items</h4>
                    ...
                    {order.items.map((item, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-center gap-4 p-4 bg-gray-800 rounded-lg hover:bg-gray-750 transition-colors">
                          <img
                            className="w-20 h-20 rounded-lg object-cover border border-green-600"
                            src={imageUrl}
                            alt={item.name}
                            onError={(e) => {
                          ...
                          <div className="flex-1">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-gray-300 mt-2 text-sm">
              ...
              {order.address && (
                <div className="bg-gray-800 rounded-lg p-4">
                  <h4 className="text-green-400 font-semibold mb-3">Shipping Address</h4>
